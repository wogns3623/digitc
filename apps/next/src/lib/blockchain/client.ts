...
export function getClient<account extends Account | undefined>(
  account?: account,
) {
  const walletClient = getWalletClient(account);

  return walletClient.extend(publicActions) as Client<
    Transport,
    Chain,
    account,
    undefined,
...
export const knownAccounts: { publicKey: Hex; privateKey: Hex }[] = [
  {
